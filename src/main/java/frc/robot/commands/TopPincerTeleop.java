...
public class TopPincerTeleop extends CommandBase {
  /** Creates a new AutonomousPincer. */
   double upperArmRotationsNeeded = Constants.topUpperArmRotations;
   double lowerArmRotationsNeeded = Constants.topLowerArmRotations;
  public boolean finished = false;

  public TopPincerTeleop() {
  ...
  public void initialize() {
    ...
    upperArmRotationsNeeded = Constants.topUpperArmRotations;
    lowerArmRotationsNeeded = Constants.topLowerArmRotations;
