...
public class BottomPincerTeleop extends CommandBase {
  /** Creates a new AutonomousPincer. */
   double upperArmRotationsNeeded = Constants.bottomUpperArmRotations;
   double lowerArmRotationsNeeded = Constants.bottomLowerArmRotations;
  public boolean finished = false;

  public BottomPincerTeleop() {
  ...
  public void initialize() {
    ...
    upperArmRotationsNeeded = Constants.bottomUpperArmRotations;
    lowerArmRotationsNeeded = Constants.bottomLowerArmRotations;
